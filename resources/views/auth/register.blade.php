        ...
        <div class="centered-content">
            <form id="signUpForm" action="{{route('store')}}" method="post">
                ...
                <div class="wave-group">
                    <input required="" maxlength="50" type="email" class="input @error('email') is-invalid @enderror"
                           id="email" name="email"
                           value="{{old('email')}}">
                    @if ($errors->has('email'))
                ...
                <br>
                <div class="wave-group">
                    <input required="" type="text" class="input @error('pseudo') is-invalid @enderror"
                ...
                <div class="wave-group">
                    <input required="" maxlength="50" type="text"
                           class="input @error('last_name') is-invalid @enderror" id="last_name"
                ...
                <br>
                <div class="wave-group">
                    <input type="date" class="input @error('birth_date') is-invalid @enderror"
                           id="birth_date"
                ...
                <div class="wave-group">
                    <input required="required" type="password" class="input @error('password') is-invalid @enderror"
